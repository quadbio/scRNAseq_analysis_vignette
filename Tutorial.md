...
As a test for yourself, please try to apply what is learned in the first part to DS2 before doing part 2 of the vignette. This would also give you idea which types of cells are in DS2, and whether it is comparable with DS1, before doing any data integration.
